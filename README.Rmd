...
An R package with two functions: `wisdom()` and `wisdom_on_startup()`. `wisdom()` dispenses a randomly selected piece of wisdom from Merlin Mann's [Wisdom Project](https://github.com/merlinmann/wisdom). `wisdom_on_startup()` sets R to dispense a randomly selected piece of wisdom from Merlin Mann's [Wisdom Project](https://github.com/merlinmann/wisdom) on startup. 

The code for this package was borrowed liberally from [mkearney](https://github.com/mkearney)'s [{mitchhedberg}](https://github.com/mkearney/mitchhedberg) package.

## Installation

The development version of `{merlinmann}` can be installed from [Github](https://github.com) with:
